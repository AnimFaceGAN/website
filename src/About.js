...
function About() {
  return (
    <div>
      ...
      <div className='feature-1 feature-block'>
        <div className='feature-img' id='feature-img'>
          <video className='img' autoplay loop playsinline muted>
            <source src={feature1_webm} type='video/webm' />
            <source src={feature1_mp4} type='video/mp4' />
          </video>
        </div>
        <div className='feature-desc' id='feature-desc'>
            <b>必要なものは1枚のイラストだけ</b>
            <p>
              １枚のイラストからアバターが作れます。
      ...
      <div className='feature-2 feature-block'>
        <div className='feature-img' id='feature-img'>
            <img className='img' src={feature2} alt='feature2 img' />
        </div>
        <div className='feature-desc' id='feature-desc'>
          <b>画像生成AI(GAN)の利用</b>
          <p>
      ...
      <div className='feature-3 feature-block'>
        <div className='feature-img' id='feature-img'>
            <img className='img' src={feature3} alt='feature3 img' />
        </div>
        <div className='feature-desc' id='feature-desc'>
          <b>ビデオ通話を楽しく</b>
          <p>
